...
export class Tile {
  ...
  scrambleTo(targetChar, delay) {
    ...
    setTimeout(() => {
      ...
      // Lese Scramble-Farben einmal aus CSS-Variablen (theme-aware)
      const scrambleColors = getScrambleColors();

      // Einfache Helligkeits-Heuristik
      ...
      this._scrambleTimer = setInterval(() => {
        ...
        const color = scrambleColors[scrambleCount % scrambleColors.length];
